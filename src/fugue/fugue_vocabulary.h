...
inline constexpr MelodicFigure kBassLeapStep = {"bass_leap_step",
                                                IntervalMode::Degree,
                                                true,
                                                nullptr,
                                                kBassLeapStep_dg,
                                                ...
                                                detail::kEqO4,
                                                4,
                                                "BWV574:pedal:b35, BWV576:pedal:b65"};
...
inline constexpr MelodicFigure kBassOctaveZig = {"bass_octave_zig",
                                                 IntervalMode::Degree,
                                                 true,
                                                 nullptr,
                                                 kBassOctaveZig_dg,
                                                 ...
                                                 detail::kEqO4,
                                                 4,
                                                 "BWV576:pedal:b65, BWV575:pedal:b7"};
...
inline constexpr MelodicFigure kBassHarmonicDrop = {"bass_harmonic_drop",
                                                    IntervalMode::Degree,
                                                    true,
                                                    nullptr,
                                                    kBassHarmonicDrop_dg,
                                                    detail::kEqR4,
                                                    detail::kEqO4,
                                                    4,
                                                    "BWV575:pedal:b60, BWV577:pedal:b32"};
...
inline constexpr MelodicFigure kBassInvZig = {"bass_inv_zig",
                                              IntervalMode::Degree,
                                              true,
                                              nullptr,
                                              kBassInvZig_dg,
                                              ...
                                              detail::kEqO4,
                                              4,
                                              "BWV576:pedal:b64, BWV574:pedal:b54"};
...
inline constexpr MelodicFigure kBassResolve = {
    "bass_resolve", IntervalMode::Degree, true, nullptr,           kBassResolve_dg,
    detail::kEqR4,  detail::kEqO4,        4,    "BWV574:pedal:b13"};

inline constexpr const MelodicFigure* kFugueBassPatterns[] = {
    &kBassLeapStep, &kBassOctaveZig, &kBassHarmonicDrop, &kBassInvZig, &kBassResolve,
};
...
inline constexpr MelodicFigure kEpisodeSeq = {
    "episode_seq", IntervalMode::Degree, true, nullptr,           kEpisodeSeq_dg,
    detail::kEqR4, detail::kEqO4,        4,    "BWV576:upper:b41"};
...
inline constexpr MelodicFigure kBroken3rd = {
    "broken_3rd",  IntervalMode::Degree, true, nullptr,           kBroken3rd_dg,
    detail::kEqR4, detail::kEqO4,        4,    "BWV574:upper:b87"};
