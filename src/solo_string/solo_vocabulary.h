...
inline constexpr FigurationSlotPattern kFig3vFalling = {"3v_falling",  kFig3vFalling_s, 3, 3, 4,
                                                        "BWV1007_1:b8"};

// 3v rising: bass → alto → soprano (288 occ, 34/36 works)
inline constexpr uint8_t kFig3vRising_s[] = {0, 1, 2};
inline constexpr FigurationSlotPattern kFig3vRising = {"3v_rising", kFig3vRising_s, 3, 3,
                                                       4,           "BWV1007_1:b9"};

// 3v arch: alto → soprano → bass (263 occ, 34/36 works)
inline constexpr uint8_t kFig3vArch_s[] = {1, 2, 0};
inline constexpr FigurationSlotPattern kFig3vArch = {"3v_arch", kFig3vArch_s,   3, 3,
                                                     0,         "BWV1007_1:b33"};

// 3v dip: alto → bass → soprano (215 occ, 34/36 works)
inline constexpr uint8_t kFig3vDip_s[] = {1, 0, 2};
inline constexpr FigurationSlotPattern kFig3vDip = {"3v_dip", kFig3vDip_s, 3,
                                                    3,        0,           "BWV1007_1:b24"};

// 3v mixed: soprano → bass → alto (154 occ, 32/36 works)
inline constexpr uint8_t kFig3vMixed_s[] = {2, 0, 1};
inline constexpr FigurationSlotPattern kFig3vMixed = {"3v_mixed", kFig3vMixed_s,  3, 3,
                                                      0,          "BWV1007_1:b17"};
...
inline constexpr FigurationSlotPattern kFig4vRising = {"4v_rising", kFig4vRising_s, 4, 4,
                                                       0,           "BWV1007_1:b23"};

// 4v falling: soprano → alto → tenor → bass (36 occ, 16/36 works)
inline constexpr uint8_t kFig4vFalling_s[] = {3, 2, 1, 0};
inline constexpr FigurationSlotPattern kFig4vFalling = {"4v_falling",   kFig4vFalling_s, 4, 4, 0,
                                                        "BWV1007_1:b10"};

// 4v mixed: alto → bass → tenor → soprano (31 occ, 12/36 works)
inline constexpr uint8_t kFig4vMixed_s[] = {2, 0, 1, 3};
inline constexpr FigurationSlotPattern kFig4vMixed = {"4v_mixed", kFig4vMixed_s, 4, 4,
                                                      0,          "BWV1007_1:b6"};
...
inline constexpr FigurationSlotPattern kFig2vOscUp = {"2v_osc_up", kFig2vOscUp_s, 3, 2,
                                                      0,           "BWV1007_1:b4"};

// 2v oscillation down: bass → soprano → bass (148 occ, 25/36 works)
inline constexpr uint8_t kFig2vOscDown_s[] = {0, 1, 0};
inline constexpr FigurationSlotPattern kFig2vOscDown = {"2v_osc_down",  kFig2vOscDown_s, 3, 2, 1,
                                                        "BWV1007_1:b17"};

inline constexpr const FigurationSlotPattern* kSoloFigurations[] = {
    &kFig3vFalling, &kFig3vRising,  &kFig3vArch,  &kFig3vDip,   &kFig3vMixed,
    &kFig4vRising,  &kFig4vFalling, &kFig4vMixed, &kFig2vOscUp, &kFig2vOscDown,
};
...
inline constexpr MelodicFigure kBariolage = {
    "bariolage", IntervalMode::Degree, true, nullptr, kBariolage_dg, detail::kEqR4, detail::kEqO4,
...
inline constexpr MelodicFigure kArpDesc = {
    "arp_desc", IntervalMode::Degree, true, nullptr, kArpDesc_dg, detail::kEqR4, detail::kEqO4,
