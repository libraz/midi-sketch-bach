...
class JsonWriter {
 public:
  ...
  /// @brief Write a trusted pre-serialized JSON value without escaping.
  /// @param raw_json Valid JSON text generated by internal serializers.
  void valueRaw(std::string_view raw_json);
