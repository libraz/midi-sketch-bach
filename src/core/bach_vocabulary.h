...
inline constexpr MelodicFigure kDescRun4 = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b33, BWV846f:upper:b3, BWV1007_1:solo:b8"};
...
inline constexpr MelodicFigure kAscRun4 = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b69, BWV846f:upper:b3, BWV1007_1:solo:b19"};
...
inline constexpr MelodicFigure kCambiataDown = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b2, BWV846f:upper:b5, BWV1007_1:solo:b20"};

// 4. Upper escape + descend (freq: 16 / 18 / 17 / 21 ‰)
inline constexpr DegreeInterval kTurnDown_dg[] = {{1, 0}, {-1, 0}, {-1, 0}};
inline constexpr MelodicFigure kTurnDown = {"turn_down",
                                            IntervalMode::Degree,
                                            true,
                                            nullptr,
                                            kTurnDown_dg,
                                            ...
                                            detail::kEqO4,
                                            4,
                                            "BWV574:upper:b7, BWV846f:upper:b2, BWV1007_1:solo:b5"};
...
inline constexpr MelodicFigure kLowerNbr = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b13, BWV846f:upper:b9, BWV1007_1:solo:b5"};
...
inline constexpr MelodicFigure kUpperNbr = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b42, BWV846f:upper:b3, BWV1007_1:solo:b5"};

// 7. Dip then ascend (freq: 11 / 13 / 15 / 18 ‰)
inline constexpr DegreeInterval kTurnUp_dg[] = {{-1, 0}, {1, 0}, {1, 0}};
inline constexpr MelodicFigure kTurnUp = {"turn_up",
                                          IntervalMode::Degree,
                                          true,
                                          nullptr,
                                          kTurnUp_dg,
                                          ...
                                          detail::kEqO4,
                                          4,
                                          "BWV574:upper:b11, BWV846f:upper:b3, BWV1007_1:solo:b11"};
...
inline constexpr MelodicFigure kEscapeDown = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b11, BWV846f:upper:b2, BWV1007_2:solo:b33"};
...
inline constexpr MelodicFigure kLeapUpStepDown = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b2, BWV846f:lower:b5, BWV1007_1:solo:b6"};
...
inline constexpr MelodicFigure kStepDownLeapUp = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b14, BWV846f:upper:b4, BWV1007_1:solo:b5"};
...
inline constexpr MelodicFigure kStepUpLeapDown = {
    ...
    detail::kEqO4,
    4,
    "BWV846f:upper:b21, BWV1007_1:solo:b9, BWV988_01:upper:b2"};
...
inline constexpr MelodicFigure kEchappee = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b14, BWV846f:upper:b5, BWV1007_1:solo:b3"};
...
inline constexpr MelodicFigure kCambiataNbr = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b33, BWV846f:upper:b14, BWV1007_1:solo:b11"};
...
inline constexpr MelodicFigure kLeapRecovery = {
    ...
    detail::kEqO4,
    4,
    "BWV574:lower:b26, BWV846f:lower:b8, BWV1007_1:solo:b11"};
...
inline constexpr MelodicFigure kChromaticDesc = {
    ...
    detail::kEqO4,
    4,
    "BWV574:upper:b35, BWV846f:upper:b16, BWV1007_3:solo:b10"};
...
inline constexpr MelodicFigure kLeapDownAscend = {
    ...
    detail::kEqO4,
    4,
    "BWV846f:lower:b8, BWV1007_1:solo:b16, BWV988_00:lower:b9"};
...
inline constexpr MelodicFigure kMordent = {"mordent",
...
inline constexpr MelodicFigure kInvMordent = {"inv_mordent",
                                              ...
                                              detail::kEqO3,
                                              3,
                                              "BWV574:upper:b3, BWV578:v1:b3"};

// 19. Trill fragment (organ: 91 occ, 7/8 works)
inline constexpr int8_t kTrill3_st[] = {1, -1, 1};
inline constexpr MelodicFigure kTrill3 = {
    "trill_3",     IntervalMode::Semitone, false, kTrill3_st,       nullptr,
    detail::kEqR4, detail::kEqO4,          4,     "BWV574:upper:b3"};
...
inline constexpr MelodicFigure kInvTrill3 = {
    "inv_trill_3", IntervalMode::Semitone, false, kInvTrill3_st,    nullptr,
    detail::kEqR4, detail::kEqO4,          4,     "BWV574:upper:b3"};
...
inline constexpr MelodicFigure kWideLowerOsc = {
    "wide_lower_osc", IntervalMode::Degree, true, nullptr,        kWideLowerOsc_dg,
    detail::kEqR4,    detail::kEqO4,        4,    "BWV578:v1:b15"};
...
inline constexpr MelodicFigure kWideUpperOsc = {
    "wide_upper_osc", IntervalMode::Degree, true, nullptr,        kWideUpperOsc_dg,
    detail::kEqR4,    detail::kEqO4,        4,    "BWV578:v1:b28"};
...
inline constexpr MelodicFigure kTrill5 = {"trill_5",
                                          IntervalMode::Semitone,
                                          false,
                                          kTrill5_st,
                                          nullptr,
...
inline constexpr MelodicFigure kAscRun5 = {"asc_run_5",
                                           ...
                                           detail::kEqO5,
                                           5,
                                           "BWV565:v1:b18, BWV537_fantasia:v1:b5"};
...
inline constexpr MelodicFigure kBrechungDesc = {"brechung_desc",
                                                IntervalMode::Degree,
                                                true,
                                                nullptr,
                                                kBrechungDesc_dg,
                                                ...
                                                detail::kEqO5,
                                                5,
                                                "BWV565:v1:b15, BWV542_fantasia:v1:b8"};
...
inline constexpr MelodicFigure kTurnUpNbr = {"turn_up_nbr",
                                             IntervalMode::Degree,
                                             true,
                                             nullptr,
                                             kTurnUpNbr_dg,
                                             ...
                                             detail::kEqO5,
                                             5,
                                             "BWV537_fantasia:v1:b12, BWV531_prelude:v1:b7"};
...
inline constexpr DegreeInterval kBrechungAsc_dg[] = {{3, 0}, {-1, 0}, {2, 0}, {-1, 0}};
...
inline constexpr MelodicFigure kBrechungAsc = {"brechung_asc",
                                               IntervalMode::Degree,
                                               true,
                                               nullptr,
                                               kBrechungAsc_dg,
                                               ...
                                               kBrechungAsc_onset,
                                               5,
                                               "BWV538:manual:toccata"};

// 30. Wide Brechung descending: 4th-step-5th-step
inline constexpr DegreeInterval kBrechungWideDesc_dg[] = {{-4, 0}, {1, 0}, {-5, 0}, {2, 0}};
...
inline constexpr MelodicFigure kBrechungWideDesc = {"brechung_wide_desc",
                                                    IntervalMode::Degree,
                                                    true,
                                                    nullptr,
                                                    kBrechungWideDesc_dg,
                                                    kBrechungWideDesc_rhythm,
                                                    kBrechungWideDesc_onset,
                                                    5,
                                                    "BWV540:manual:toccata"};

// 31. Arpeggio sweep ascending: 3rd+3rd+step
inline constexpr DegreeInterval kArpSweepAsc_dg[] = {{2, 0}, {2, 0}, {1, 0}};
...
inline constexpr MelodicFigure kArpSweepAsc = {"arp_sweep_asc",
                                               IntervalMode::Degree,
                                               true,
                                               nullptr,
                                               kArpSweepAsc_dg,
...
inline constexpr DegreeInterval kArpSweepDesc_dg[] = {{-2, 0}, {-2, 0}, {-1, 0}};
...
inline constexpr MelodicFigure kArpSweepDesc = {"arp_sweep_desc",
                                                IntervalMode::Degree,
                                                true,
                                                nullptr,
                                                kArpSweepDesc_dg,
                                                kArpSweepDesc_rhythm,
                                                kArpSweepDesc_onset,
                                                4,
                                                "BWV540:manual:toccata"};
...
inline constexpr const MelodicFigure* kCommonFigures[] = {
    &kDescRun4,       &kAscRun4,      &kCambiataDown, &kTurnDown,       &kLowerNbr,
    &kUpperNbr,       &kTurnUp,       &kEscapeDown,   &kLeapUpStepDown, &kStepDownLeapUp,
    &kStepUpLeapDown, &kEchappee,     &kCambiataNbr,  &kLeapRecovery,   &kChromaticDesc,
    &kLeapDownAscend, &kMordent,      &kInvMordent,   &kTrill3,         &kInvTrill3,
    &kWideLowerOsc,   &kWideUpperOsc, &kTrill5,       &kWideOsc5,       &kDescRun5,
    &kAscRun5,        &kBrechungDesc, &kTurnUpNbr,
};
...
inline constexpr RhythmCell kRunning16th = {"running_16th", kRunning16th_r,  kRunning16th_o, 4,
                                            1.0f,           "all categories"};
...
inline constexpr RhythmCell kRunning8th = {"running_8th", kRunning8th_r,   kRunning8th_o, 4,
                                           2.0f,          "all categories"};
...
inline constexpr RhythmCell kRunningQtr = {"running_qtr", kRunningQtr_r,   kRunningQtr_o, 4,
                                           4.0f,          "all categories"};
...
inline constexpr RhythmCell kLombardic = {"lombardic", kLombardic_r, kLombardic_o,
                                          4,           1.25f,        "all categories"};
...
inline constexpr RhythmCell kDottedPair = {"dotted_pair", kDottedPair_r,   kDottedPair_o, 4,
                                           1.5f,          "all categories"};
...
inline constexpr RhythmCell kShortLong = {"short_long", kShortLong_r,    kShortLong_o, 4,
                                          1.25f,        "all categories"};
...
inline constexpr RhythmCell kLongShort = {"long_short", kLongShort_r,    kLongShort_o, 4,
                                          1.25f,        "all categories"};
...
inline constexpr RhythmCell kQtrStart = {"qtr_start", kQtrStart_r, kQtrStart_o,
                                         4,           2.5f,        "all categories"};
...
inline constexpr RhythmCell kRunning32nd = {"running_32nd", kRunning32nd_r,    kRunning32nd_o, 4,
                                            0.5f,           "organ_pf toccata"};
...
inline constexpr RhythmCell kMixed32_16 = {"mixed_32_16", kMixed32_16_r,        kMixed32_16_o, 4,
                                           0.75f,         "organ_pf transition"};
...
inline constexpr VoiceIntervalProfile kOrganBassProfile = {"organ_bass", 0.44f, 0.52f,
                                                           3.9f,         19,    "BWV578:pedal"};
inline constexpr VoiceIntervalProfile kCelloProfile = {"cello_suite", 0.55f, 0.38f,
                                                       2.9f,          12,    "BWV1007-1012 avg"};
inline constexpr VoiceIntervalProfile kWTCProfile = {"wtc1", 0.49f, 0.47f,
                                                     3.4f,   12,    "BWV846-869 avg"};
inline constexpr VoiceIntervalProfile kGoldbergProfile = {"goldberg", 0.53f, 0.43f,
                                                          3.2f,       12,    "BWV988 avg"};

inline constexpr const VoiceIntervalProfile* kVoiceProfiles[] = {
    &kOrganUpperProfile, &kOrganBassProfile, &kCelloProfile, &kWTCProfile, &kGoldbergProfile,
};
...
inline constexpr BassHarmonicConstraint kOrganPedalConstraint = {0.65f, 0.85f, 2, "BWV578:pedal"};
